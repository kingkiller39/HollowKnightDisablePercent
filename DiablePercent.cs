...
{
    public class DisablePercent : Mod, ITogglableMod
    {
        ...
        public override string GetVersion() => FileVersionInfo.GetVersionInfo(Assembly.GetAssembly(typeof(DisablePercent)).Location).FileVersion;
